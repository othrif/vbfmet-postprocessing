...
def writeMultiJet(Binning=0, year=2016, METCut=150, doDoubleRatio=False, singleHist=False):
    ...
    if year==2017:
        if Binning==11:
            ...
            multijets_statunc = [43.1,36.7,12.1,10.4,2.8,22.6,28.0,17.1,9.3,2.6,26.5]
            tmpmj= [169.6, 151.2, 57., 31.4, 3.4, 125.1, 166.1, 72.5, 25.3, 2.6, 160.5]
            tmpmj_statunc = [43.1,36.7,12.1,10.4,2.8,22.6,28.0,17.1,9.3,2.6,26.5]
            if METCut>150:
                if METCut==160:
                    MJSF=0.6991
        ...
        if Binning==11:
            ...
            tmpmj = [176.8, 291.8, 54.0, 49.1, 2.95, 336., 144.7, 76.1, 68.7, 0.0, 331.0] # MET>150... from scaling to low mjj
            tmpmj_statunc = [31.8,52.1,15.5,25.5,2.95,69.5,23.5,19.1,29.4,0.2,58.7]
            if METCut>150:
