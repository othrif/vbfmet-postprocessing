#ifndef ZHDARKPHANALYSIS_ZHDARKPHANALYSISALG_H
#define ZHDARKPHANALYSIS_ZHDARKPHANALYSISALG_H 1
...
class ZHDarkPhAnalysisAlg: public ::AthAnalysisAlgorithm {
 public:
  ZHDarkPhAnalysisAlg( const std::string& name, ISvcLocator* pSvcLocator );
  virtual ~ZHDarkPhAnalysisAlg();
...
#endif //> !ZHDARKPHANALYSIS_ZHDARKPHANALYSISALG_H
