...
#name_model='_zstrong'
name_model = '_zstrong_ttbar_wstrong_zewk_qg_v26-v28_merged'
#name_model='_zstrong'
#name_model='_njet'
#idir='/share/t3data2/schae/v26LooseNoExtSystMETTrigSYST/'
idir='/share/t3data2/schae/v26LooseQGVars/'
#odir='/share/t3data2/schae/v26Loose_BTAGW_TightSkim_7var'+name_model+'/'
odir='/home/smau/testarea/v26LooseQGVars'+name_model+'/'
...
model_dir='./'
model = load_model(model_dir+'model'+name_model+'.hdf5', custom_objects={'focal_loss': focal_loss, 'sig_eff': sig_eff})
# load the scaler
    ...
    for key in file_tree_list:
        ...
        if key.GetClassName()=='TTree' and key.GetName().count('Nominal'):
            ...
            for e in tree_in:
                ...
                vbf+=[[e.jj_mass, e.jj_dphi, e.jj_deta, e.met_tst_nolep_et, e.jet_pt[0], e.jet_pt[1], e.met_tenacious_tst_et, e.met_soft_tst_et, e.met_cst_jet, e.n_jet, e.maxCentrality]] #, e.jet_NTracks[0], e.jet_NTracks[1]]]
