...
if __name__ == "__main__":
    ...
    tIncl.Draw(pvar+'/1.0e3 >>'+n1,'w*36000.0'+cuts)
    ...
    tVBFFilt.Draw(pvar+'/1.0e3 >>'+n2,'w*36000.0'+cuts)
    ...
    leg.SetTextFont(42);
    leg.SetTextSize(0.04);
    leg.AddEntry(plt,'Inclusive')
    leg.AddEntry(vbfplt,'VBF Filtered')
    ...
    hratio = sumed.Clone()
    hratio.Divide(plt)
    hratio.GetYaxis().SetTitle('Merged/Incl')
