...
def getSelKeyLabel(selkey):
    ...
    if selkey != None: # and selkey.count('hww') or selkey.count('lowmet'):
        ...
        elif selkey.count('mjjLow200_') or selkey.count('mjjLowNjet_'):  proc += ', 0.2<M_{jj}<0.8TeV'
...
def getHistPars(hist):
    ...
    labels = {
        ...
        'jj_mass'    : {'xtitle':'m_{jj} [GeV]'  ,                   'ytitle':'Events / (500 GeV)', 'rebin':5,  'ymin':1.0,'logy':True, 'LtoRCut':0},
    ...
    'j2Eta'     : {'xtitle':'j2 #eta (njet==2)'   ,         'ytitle':'Events',   'ymin':0.1},
    'j2fvt'     : {'xtitle':'j2 f-Jvt (njet==2)'   ,         'ytitle':'Events',   'ymin':0.1},
    'j2metsig'     : {'xtitle':'MET Significance [GeV^{1/2}] (njet==2)'   ,         'ytitle':'Events', 'rebin':10,  'ymin':0.01,'logy':True},
    'j2fvt_eta28'     : {'xtitle':'j2 f-Jvt (njet==2, |#eta(j_#2)|>2.8)'   ,         'ytitle':'Events',   'ymin':0.1},
    'j2metsig_eta28'     : {'xtitle':'MET Significance [GeV^{1/2}] (njet==2, |#eta(j_#2)|>2.8)'   ,         'ytitle':'Events', 'rebin':10,  'ymin':0.01,'logy':True},
    ...
    'j3metsig'     : {'xtitle':'MET Significance [GeV^{1/2}] (njet>2)'   ,         'ytitle':'Events', 'rebin':10,  'ymin':0.01,'logy':True},
    'j3fvt_eta28'     : {'xtitle':'j3 f-Jvt (njet>2, |#eta(j_#3)|>2.8)'   ,         'ytitle':'Events',   'ymin':0.1},
    'j3metsig_eta28'     : {'xtitle':'MET Significance [GeV^{1/2}] (njet>2, |#eta(j_#3)|>2.8)'   ,         'ytitle':'Events', 'rebin':10,  'ymin':0.01,'logy':True},
