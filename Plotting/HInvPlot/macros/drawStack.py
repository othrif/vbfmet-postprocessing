...
def getHistPars(hist):
    ...
    'jetTrackWidth02125' : {'xtitle':'Track Width (leading) if 2.1<|#eta|<2.5',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetTrackWidth12125' : {'xtitle':'Track Width (subleading) if 2.1<|#eta|<2.5',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetNTracks02125' : {'xtitle':'NTracks (leading) if 2.1<|#eta|<2.5',          'ytitle':'Events','logy':True, 'LtoRCut':3},
    'jetNTracks12125' : {'xtitle':'NTracks (subleading) if 2.1<|#eta|<2.5',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetTrackWidth025' : {'xtitle':'Track Width (leading) if |#eta|<2.5',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetTrackWidth125' : {'xtitle':'Track Width (subleading) if |#eta|<2.5',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetNTracks025' : {'xtitle':'NTracks (leading) if |#eta|<2.5',          'ytitle':'Events','logy':True, 'LtoRCut':3},
    'jetNTracks125' : {'xtitle':'NTracks (subleading) if |#eta|<2.5',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetTrackWidth021' : {'xtitle':'Track Width (leading) if |#eta|<2.1',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetTrackWidth121' : {'xtitle':'Track Width (subleading) if |#eta|<2.1',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    'jetNTracks021' : {'xtitle':'NTracks (leading) if |#eta|<2.1',          'ytitle':'Events','logy':True, 'LtoRCut':3},
    'jetNTracks121' : {'xtitle':'NTracks (subleading) if |#eta|<2.1',          'ytitle':'Events', 'logy':True, 'LtoRCut':3},
    ...
    'qgTaggerSim' : {'xtitle':'', 'ytitle':'Events', 'logy':True, 'LtoRCut':4},
    'qgTaggerSimLog' : {'xtitle':'', 'ytitle':'Events', 'logy':True, 'LtoRCut':4},
    'qgTaggerSimLin' : {'xtitle':'', 'ytitle':'Events', 'logy':True, 'LtoRCut':4},
