...
#-----------------------------------------
def Style():
    atlas_style_path='/afs/cern.ch/work/a/asteinhe/atlasstyle/'
...
def MakeRatio(indir1, indir2, plot_name,can):
    ...
    dpltv1.GetYaxis().SetTitle('17 / 18')
    ...
    can.Update()
    #can.WaitPrimitive()
    na = indir1+plot_name.replace('.pdf','_ratio78.pdf')
    can.SaveAs(na)
    return na
if __name__ == "__main__":
    ...
    f=open('vbf_20172018_ratios.tex','w')
    ...
    filelist = ['Nominal_jj_mass_Nominal.pdf','Nominal_jj_deta_Nominal.pdf','Nominal_jj_dphi_Nominal.pdf','Nominal_met_tst_et_Nominal.pdf','Nominal_met_soft_tst_et_Nominal.pdf','Nominal_j0fjvt_Nominal.pdf','Nominal_j1fjvt_Nominal.pdf','Nominal_jetPt0_Nominal.pdf','Nominal_jetPt1_Nominal.pdf','Nominal_n_jet_Nominal.pdf','Nominal_lepPt0_Nominal.pdf','Nominal_lepPt1_Nominal.pdf', 'Nominal_centrality_Nominal.pdf','Nominal_j3Eta_Nominal.pdf','Nominal_j3Jvt_Nominal.pdf','Nominal_j3FJvt_Nominal.pdf','Nominal_j3Pt_Nominal.pdf','Nominal_met_significance_Nominal.pdf','Nominal_met_tst_nolep_et_Nominal.pdf','Nominal_min_mj3_over_mjj_Nominal.pdf','Nominal_mll_Nominal.pdf','Nominal_ptll_Nominal.pdf','Nominal_nTruthJetMatch_Nominal.pdf']
    titles = ['Jet Invariant Mass', 'Jet rapidity separation', 'Jet $\\phi$ Separation','MET','MET soft', 'Lead Jet fjvt','SubLead Jet fjvt','Leading Jet $p_{T}$','SubLeading Jet $p_{T}$','Number of Jets','Leading Lepton $p_{T}$','subLeading Lepton $p_{T}$','Jet Centrality','Third Jet Eta','Third Jet JVT','Third Jet FJVT','Third Jet $p_{T}$','MET Significance','TST MET, No Lepton','Min(MJ3)/$M_{jj}$','Di-Lepton Invariant Mass','Di-Lepton $p_{T}$','Nmb. Truth-Matched Jets']
    ...
    for s in samples:
        ...
        for fi in filelist:
            ...
            f.write(Get3Chart(names=[dir1+s+fi,dir2+s+fi,n], title=titles[i],xtitle='2017',ytitle='2018'))
            i+=1
    f.write(GetEnd())
    f.close()
